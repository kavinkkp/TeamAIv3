 ...
 */
if (!function_exists('business_solution_get_theme_css')):

function business_solution_get_theme_css( ) {
	...
	$colors['link_color'] = get_theme_mod('link_color', '#063d62');
	$colors['main_text_color'] = get_theme_mod('main_text_color', '#1a1a1a');

	$colors['primary_color'] = get_theme_mod('primary_color', '#24adff');
	
	$colors['footer_text_color'] = get_theme_mod('footer_text_color', '#eaeaea');
	
	/* Convert main text hex color to rgba */
	$main_text_color_rgb = business_solution_hex2rgb( $colors['main_text_color'] );
	$border_color = vsprintf( 'rgba( %1$s, %2$s, %3$s, 0.2)', $main_text_color_rgb );	
	$colors['border_color'] = $border_color;
	
	$footer_bg_color = get_theme_mod('footer_bg_color', '#0c3d71');
	...
	$footer_border = get_theme_mod('footer_border', 0);
	
	$woocommerce_menubar = get_theme_mod('woocommerce_menubar_color', 'rgba(231,173,36,0)');
	
	$woocommerce_menubar_text = get_theme_mod('woocommerce_menubar_text_color', '#2b2b2b');
 ...
 *
 */
function business_solution_css_template() {
	?>
	<script type="text/html" id="tmpl-business-solution-css-scheme">
		<?php echo wp_strip_all_tags(business_solution_get_theme_css() ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'business_solution_css_template' );
