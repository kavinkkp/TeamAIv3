<?php
namespace ElementsKit\Modules\Library\Manager;
...
class Api {
	...
	public function __construct() {
		...
		// set server api url.
		$this->server_url = \ElementsKit::api_url() . 'elementor-layouts/';

		// get current directory path.
		$this->dir = dirname(__FILE__) . '/';

		// get current module's url.
        $this->url = \ElementsKit::plugin_url() . 'modules/library/templates/';
