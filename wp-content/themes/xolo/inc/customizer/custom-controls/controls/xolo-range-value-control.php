 ...
 * @access public
 */
class Xolo_Customizer_Range_Control extends WP_Customize_Control {
	...
	/**
	 * Xolo_Customizer_Range_Control constructor.
	 *
 ...
 */
function xolo_sanitize_range_value( $input ) {
	if ( xolo_is_json( $input ) ) {
