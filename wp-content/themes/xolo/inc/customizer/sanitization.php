 ...
 */
function xolo_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function xolo_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function xolo_sanitize_html( $html ) {
 ...
 */
function xolo_sanitize_image( $image, $setting ) {
 ...
 */
function xolo_sanitize_nohtml( $nohtml ) {
 ...
 */
function xolo_sanitize_number_absint( $number, $setting ) {
 ...
 */
function xolo_sanitize_select( $input, $setting ) {
 ...
 */
function xolo_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function xolo_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function xolo_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
...
function xolo_sanitize_sortable( $val = array(), $setting ) {
...
function xolo_sanitize_typography_fonts( $input ) {
	$standard = xolo_font_selector_get_standard_fonts();
	$google = xolo_font_selector_get_google_fonts_array();

	$fonts = array_flip( array_merge( $standard, $google ) );
 ...
 */
function xolo_sanitize_alpha_color( $val ) {
		if ( '' === $val ) { return ''; }
