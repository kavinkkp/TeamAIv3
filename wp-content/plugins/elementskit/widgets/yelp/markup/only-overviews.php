...
$page_url       = esc_url('https://yelp.com/') . $page_Info['pgt'] . esc_html__('/reviews', 'elementsKit-lite' );
$page_thumbnail = !empty($page_Info['picture']) ? $page_Info['picture'] : $handler_url . esc_html__('assets/images/gift-box.png', 'elementsKit-lite' );
?>
...
<div class='ekit-review-card ekit-review-card-yelp ekit-review-card-overview'>
	...
	if($ekit_review_card_top_right_logo == 'yes') { ?>
        <div class="ekit-review-card--top-right-logo">
            <img src="<?php echo $handler_url . esc_html__('assets/svg/yelo-logo-circle.svg', 'elementsKit-lite' ) ?>">
        </div> <?php
    ...
    <p class="ekit-review-card--desc small muted">
        <?php echo esc_html__('Based on ', 'elementsKit-lite')?>
        <?php echo intval($page_Info['count']) ?>
        <?php echo esc_html__(' reviews', 'elementsKit-lite')?>
    </p>

    <div class="ekit-review-card--actions">
        <a href="<?php echo $page_url ?>" target='_' class="btn">
            <?php echo esc_html__('See all reviews', 'elementsKit-lite')?>
        </a>
        <a href="<?php echo $page_url ?>" target='_' class="btn">
