<?php 
    $thumbnail = empty($user['thumbnail']) 
        ? $handler_url . esc_html__('assets/images/profile-thumbnail.png', 'elementsKit-lite')
        : $user['thumbnail']; 
...
<div class="ekit-feed-header ekit-feed-header-pinterest">
    ...
    <div class="header-left">
        ...
        <div class="ekit-feed-header--thumbnail">
            <img src="<?php echo $thumbnail ?>" alt="Profile thumbnail">
        </div>
        <!-- End thumbnail -->
        <div>
            ...
            <div class='ekit-feed-header--desc'>
                <p>
                    <?php echo $followers ?>
                    <?php esc_html__(' Followers', 'elementsKit-lite') ?>
                </p>
            </div>
            <!-- End followers -->
    ...
    <div class="header-right">
        <div class="ekit-feed-header--actions">
            <a href="<?php echo $user['link'] ?>" target="_" class="btn btn-primary btn-pill">
                <div class='circle'>
