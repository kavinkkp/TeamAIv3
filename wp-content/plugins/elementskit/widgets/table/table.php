...
class ElementsKit_Widget_table extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Data Type', 'elemenetskit'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'custom'    => esc_html__('Custom', 'elemenetskit'),
                    'csv'       => 'CSV' . esc_html__(' File','elemenetskit')
                ],
                'default'   => 'custom'
            ]);
        ...
        $repeater_header->add_control(
            ...
            [
                ...
                'placeholder'           => esc_html__( 'Table Header', 'elementskit-lite' ),
                'default'               => esc_html__( 'Table Header', 'elementskit-lite' ),
            ]
        );
        ...
        $repeater_header->add_control(
            'cell_bg_color',
            [
                'label'     => esc_html__( 'Background Color', 'elemenetskit' ),
        ...
        $repeater_header->add_control(
            'cell_text_color',
            [
                'label'     => esc_html__( 'Text Color', 'elemenetskit' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $repeater_header->add_control(
            'cell_icon_color',
            [
                'label'     => esc_html__( 'Icon Color', 'elemenetskit' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'               => [
                    [
                        'table_header_content' => esc_html__( 'Header col 1 ', 'elementskit-lite' ),
                    ],
                    [
                        'table_header_content' => esc_html__( 'Header col 2', 'elementskit-lite' ),
                    ],
                    [
                        'table_header_content' => esc_html__( 'Header col 3', 'elementskit-lite' ),
                    ],
                ],
        ...
        $this->add_control(
            'ekit_table_csv_type',
            [
                'label'     => esc_html__('File Type', 'elementskit-lite'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'file'      => esc_html__('Upload File', 'elementskit-lite'),
                    'url'       => esc_html__('Remote File URL','elementskit-lite')
                ],
                'default'   => 'file',
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Upload CSV File', 'elementskit-lite'),
                'type'      => Controls_Manager::MEDIA,
                'media_type'=> array(),
                'condition' => [
        ...
        $this->add_control(
            'ekit_table_csv_url',
            [
                'label'         => esc_html__( 'Enter a CSV File URL', 'elemenetskit' ),
        ...
        $this->add_control(
            'header_align',
            [
                'label'   => esc_html__( 'Header Alignment', 'elemenetskit' ),
                'type'    => Controls_Manager::CHOOSE,
                'options' => [
                    'left'    => [
                        'title' => esc_html__( 'Left', 'elemenetskit' ),
                        'icon'  => 'fa fa-align-left',
                    ],
                    'center' => [
                        'title' => esc_html__( 'Center', 'elemenetskit' ),
                        'icon'  => 'fa fa-align-center',
                    ],
                    'right' => [
                        'title' => esc_html__( 'Right', 'elemenetskit' ),
        ...
        $this->start_controls_section(
            'section_body',
            [
                'label'                 => esc_html__( 'Body Content', 'elementskit-lite' ),
                'condition' => [
                    'ekit_table_data_type'   => 'custom',
                ],
            ]
        ...
        $repeater_body->add_control(
            'ekit_table_row', [
                'label' => esc_html__( 'New Row', 'elementskit-lite' ),
                'type' => Controls_Manager::SWITCHER,
                'label_off' => esc_html__( 'No', 'elementskit-lite' ),
                'label_on' => esc_html__( 'Yes', 'elementskit-lite' ),
                'return_value' => esc_html__( 'Row', 'elementskit-lite' ),
            ]
        );
        ...
        $repeater_body->add_control(
            ...
            [
                'label' => esc_html__('Add a url? ', 'elementskit-lite'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'label_on' =>esc_html__( 'Yes', 'elementskit-lite' ),
                'label_off' =>esc_html__( 'No', 'elementskit-lite' ),
            ...
            [
                ...
                'default'               => [
                    [
                        ...
                        'cell_text'           => esc_html__( 'Column 1', 'elementskit-lite' ),
                        'ekit_table_row'  => 'Row',
                    ],
                    [
                        'table_body_element'  => 'cell',
                        'cell_text'           => esc_html__( 'Column 2', 'elementskit-lite' ),
                    ],
                    [
                        'table_body_element'  => 'cell',
                        'cell_text'           => esc_html__( 'Column 3', 'elementskit-lite' ),
                    ],
                    [
                        'table_body_element'  => 'cell',
                        'cell_text'           => esc_html__( 'Column 1', 'elementskit-lite' ),
        ...
        $this->add_control(
            'body_align',
            [
                'label'   => esc_html__( 'Body Alignment', 'elemenetskit' ),
                'type'    => Controls_Manager::CHOOSE,
                'options' => [
                    'left'    => [
                        'title' => esc_html__( 'Left', 'elemenetskit' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__( 'Table Settings', 'elemenetskit' ),
        ...
        $this->add_control(
            'show_serial',
            [
                'label' => esc_html__( 'Display Serial Number', 'elementskit-lite' ),
                'type'  => Controls_Manager::SWITCHER,
                'condition' => [
                    'ekit_table_data_type'  => 'custom'
                ]
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Serial Header Text', 'elementskit-lite' ),
                'type'      => Controls_Manager::TEXT,
                'default'   => '#',
                'condition' => [
                    'show_serial'   => 'yes'
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Prev Arrow Icon', 'elementskit-lite' ),
                'type' => Controls_Manager::ICONS,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Next Arrow Icon', 'elementskit-lite' ),
                'type' => Controls_Manager::ICONS,
        ...
        $this->add_control(
            'ekit_table_navigation_prev_text', [
                'label' => esc_html__('Prev Text', 'elementskit-lite'),
                'type' => Controls_Manager::TEXT,
                'default'   => 'Prev',
                'label_block' => true,
                'condition' => [
        ...
        $this->add_control(
            'ekit_table_navigation_next_text', [
                'label' => esc_html__('Next Text', 'elementskit-lite'),
                'type' => Controls_Manager::TEXT,
                'default'   => 'Next',
                'label_block' => true,
                'condition' => [
        ...
        $this->add_control(
			'ekit_data_per_page',
			array(
				'label'      => esc_html__( 'Show item per page', 'elementskit-lite' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px'
				),
        ...
        $this->add_responsive_control(
            'ekit_wrapper_margin',
            [
                'label'      => esc_html__( 'Margin', 'elemenetskit' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'default'    => [
                    'top'    => 0,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Header', 'elemenetskit' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Header Image', 'elemenetskit' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            'section_style_body',
            [
                'label' => esc_html__( 'Body', 'elemenetskit' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'cell_padding',
            [
                'label'      => esc_html__( 'Cell Padding', 'elemenetskit' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'default'    => [
                    'top'    => 17,
        ...
        $this->start_controls_tab(
            'tab_normal',
            [
                'label' => esc_html__( 'Normal', 'elemenetskit' ),
            ]
        );
        ...
        $this->start_controls_tab(
            'tab_hover',
            [
                'label' => esc_html__( 'Hover', 'elemenetskit' ),
            ]
        );
        ...
        $this->start_controls_tab(
            'tab_stripe',
            [
                'label'     => esc_html__( 'Stripe', 'elemenetskit' ),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Body Image', 'elemenetskit' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'General Settings', 'elementskit-lite' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Shadow Settings', 'elementskit-lite' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Search', 'elementskit-lite'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_search'   => 'yes'
                ]
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Input Placeholder:', 'elementskit-lite' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
        ...
        $this->end_controls_section();
         ...
         $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Info', 'elementskit-lite'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_info' => 'yes'
                ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Entries', 'elementskit-lite'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_entries' => 'yes'
                ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Navigation', 'elementskit-lite'),
                'tab'   => Controls_Manager::TAB_STYLE
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Next and Previous Button Settings:', 'elementskit-lite' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__( 'Prev BTN Padding', 'elemenetskit' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'default'    => [
                    'top'    => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__( 'Next BTN Padding', 'elemenetskit' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'default'    => [
                    'top'    => 0,
        ...
        $this->add_control(
            ...
            [
                'label' =>esc_html__( 'Button Text Color', 'elementskit-lite' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'fields_options' => [
                    'typography' => [
                        'label' => esc_html__( 'Button Text Typography', 'elementskit-lite' ),
                    ],
                ],
            ]
        );
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Use Width and Height', 'elementskit-lite' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
				'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
				'return_value' => 'yes',
    ...
    protected function render_csv_data($url){
        ...
        if($url_ext === 'csv'){
            ...
            echo '<p class="ekit-no-csv-file-found">'. esc_html__('Please provide an csv file', 'elementskit-lite') .'</p>';
        }
        return \ob_get_clean();
    }
    ...
    protected function render_raw( ) {
        ...
        <div class="ekit_table display  ekit_table_data_type-<?php echo esc_attr( $ekit_table_data_type ); ?>" <?php echo $this->get_render_attribute_string('table'); ?>>
                ...
                if($ekit_table_data_type == 'custom'){
                    ...
                    echo \ElementsKit_Lite\Utils::render($settings['show_serial'] === 'yes' ? "<th>". $settings['show_serial_header_text'] ."</th>" : '');
                   ...
                   $row_count = 1;
                    foreach((array)$table_body_content as $bodycon){
                        ...
                        $body_cell_url = !empty($bodycon['body_cell_url']) ? $bodycon['body_cell_url'] : '';
                        $target     = !empty($body_cell_url) && $bodycon['body_cell_url']['is_external'] ? ' target="_blank"' : '';
                        $nofollow   = !empty($body_cell_url) && $bodycon['body_cell_url']['nofollow'] ? ' rel="nofollow"' : '';
                        $url        = !empty($body_cell_url) && $bodycon['body_cell_url']['url'];
                        // end url

                        if($bodycon['ekit_table_row'] == 'Row') {
                            echo "<tr>";
                            echo \ElementsKit_Lite\Utils::render($settings['show_serial'] === 'yes' ? '<td class="elementor-repeater-item-'. $bodycon['_id'] .' ekit_table_data_'. $bodycon['cell_icon_position'] .'"><div class="ekit_table_body_container ekit_table_data_'. $bodycon['cell_icon_position'] .' ekit_body_align_'. $settings['body_align'] .'">'. $row_count .'</div></td>' : '');
                            $row_count++;
                        }
                        ...
                        ?>
                            <td data-order="<?php echo esc_attr($bodycon['cell_text']); ?>" class="elementor-repeater-item-<?php echo esc_attr($bodycon['_id']); ?> ekit_table_data_<?php echo esc_attr($bodycon['cell_icon_position']); ?>">
                                <?php if($enabledUrl === 'yes') : ?>
                                    <a href="<?php echo esc_url($url); ?>" <?php echo \ElementsKit_Lite\Utils::render($target . $nofollow ); ?>>
                                <?php endif; ?>
