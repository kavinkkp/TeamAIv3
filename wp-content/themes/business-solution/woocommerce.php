 ...
 */
get_header();
$business_solution_sidebar_pos = get_theme_mod('woo_sidebar_position', 'left');
?>

<div id="content" class="site-content">

<?php if ( $business_solution_sidebar_pos =='left' && is_active_sidebar( 'woocommerce-sidebar-1' ) ): ?>
...
<?php if ( $business_solution_sidebar_pos =='right' && is_active_sidebar( 'woocommerce-sidebar-1' ) ): ?>
	<aside id="secondary" class="sidebar woocommerce widget-area col-xs-12 col-sm-4 col-md-3 col-lg-3" role="complementary">
			<?php dynamic_sidebar( 'woocommerce-sidebar-1' ); ?>
	</aside>
<?php endif; ?>
