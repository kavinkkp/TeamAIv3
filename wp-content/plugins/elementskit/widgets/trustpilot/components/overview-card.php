<div class="ekit-review-overview-trustpilot">
   <div class="d-flex justify-content-between">
      <div>
         <h5 class="ekit-review-overview-trustpilot--title">
            <?php echo esc_html__('Reviews from Trustpilot', 'elementsKit-lite')?>
         </h5>
         <div class='d-flex'>
            <!-- Start Rating stars -->
            ...
            <p class="ekit-review-overview-trustpilot--rating mb-0">
               <?php echo esc_html__('4.95', 'elementsKit-lite')?>
            </p>
         </div>
      </div>
      <div>
         ...
         <p class="ekit-review-overview-trustpilot--desc mb-0">
            <?php echo esc_html__('Recommended by 3542 people', 'elementsKit-lite')?>
         </p>
      </div>
   </div>
   ...
   <div class='d-flex justify-content-center'>
      <h6 class="ekit-review-overview-trustpilot--qs">
         <?php echo esc_html__('Would you rate us on Trustpilot?', 'elementsKit-lite')?>
      </h6>
