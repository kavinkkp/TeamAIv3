...
class ElementsKit_Widget_Behance_Feed extends Widget_Base {
    ...
    private function control_icon( $name, $selector, $config ) {
		...
		$this->add_control(  $key . 'heading', [
			'label'     => esc_html__(ucwords($name), 'elementsKit-lite'),
			'type'      => Controls_Manager::HEADING
        ]);
    ...
    private function control_section_settings(){
		...
		$this->add_control( 'ekit_feed_flex_fetch_per_request', [
            'label'   => esc_html__('Fetch Per Request', 'elementsKit-lite'),
            'type'    => Controls_Manager::SELECT,
            'default' => '12',
            'options' => [
                '6'  => esc_html__('6', 'elementsKit-lite'),
                '12' => esc_html__('12', 'elementsKit-lite'),
                '18' => esc_html__('18', 'elementsKit-lite'),
                '24' => esc_html__('24', 'elementsKit-lite'),
                '30' => esc_html__('30', 'elementsKit-lite'),
            ],
        ]);

        // Delete cache
		$this->add_control( 'behance_delete_cache', [
            'label'       => __('', 'elementsKit-lite'),
            'type'        => \Elementor\Controls_Manager::BUTTON,
            'button_type' => 'info',
            'text'        => __(' Delete Cache ', 'elementsKit-lite') . '<span class="elementor-state-icon">
    ...
    private function control_section_layout(){
        ...
        // Flex column count [ekit_behance_feed_column_count]
        $this->add_responsive_control('column_count', [
        ...
        $row = '.ekit-feed-items-wrapper-behance .row';
        $column = $row . ' > div';
		$this->add_responsive_control( 'column_gap', [
            ...
            'selectors'       => [
                '{{WRAPPER}} ' . $row => 'margin-right: -{{SIZE}}{{UNIT}};',
                '{{WRAPPER}} ' . $column => 'padding-right: {{SIZE}}{{UNIT}};padding-bottom: {{SIZE}}{{UNIT}};',
            ]
        ]);
    ...
    private function control_section_header_buttons(){
		...
		$this->add_control('header_message_button_heading', [
			'label'     => esc_html__('Message', 'elementsKit-lite'),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before'
        ]);
        
		$this->control_button('header_message_button', '.ekit-feed-header-behance .ekit-feed-header--actions .btn:last-child');
    ...
    private function control_section_card_title(){
        ...
        $this->add_responsive_control( 'card_title_min_height', [
            'label' => __( 'Min Height', 'elementsKit-lite' ),
            'type' => Controls_Manager::SLIDER,
            'size_units' => [ 'px', 'em' ],
            'range' => [
    ...
    private function control_section_hover_overlay(){
        ...
        $this->add_control( 'arrow_icons', [
            'label' => esc_html__( 'Arrow Icon', 'elementsKit-lite' ),
            'type' => Controls_Manager::ICONS,
	...
	protected function _register_controls() {
        ...
        $this->controls_section([
            'name'      => 'header_buttons',
            'label'     => esc_html__('Header Buttons', 'elementsKit-lite'),
            'tab'       => Controls_Manager::TAB_STYLE
        ]);
        ...
        $this->controls_section([
            ...
            'label'     => esc_html__('Cards Container', 'elementsKit-lite'),
            'tab'       => Controls_Manager::TAB_STYLE
        ]);
        ...
        $this->controls_section([
            'name'      => 'feed_card',
            'label'     => esc_html__('Feed Card', 'elementsKit-lite'),
            'tab'       => Controls_Manager::TAB_STYLE
        ]);
        ...
        $this->controls_section([
            'name'      => 'card_title',
            'label'     => esc_html__('Card Title', 'elementsKit-lite'),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [
                'card_styles!' => 'style1'
            ]
        ...
        $this->controls_section([
            'name'      => 'overview',
            'label'     => esc_html__('Overview', 'elementsKit-lite'),
            'tab'       => Controls_Manager::TAB_STYLE
        ]);
        ...
        $this->controls_section([
            'name'      => 'hover_overlay',
            'label'     => esc_html__('Hover Overlay', 'elementsKit-lite'),
            'tab'       => Controls_Manager::TAB_STYLE
        ]);
	...
	protected function render_raw() {
		...
		if(empty($settings['behance_user_name'])) : ?>
            <div>
                <strong>
                    <?php echo esc_html__('Please set a valid username first', 'elementsKit-lite')?>
                </strong>
            </div>
        <?php else:
            ...
            if($data['success'] && $data['data']['feed']->http_code == 200):
                    ...
                    <div class="ekit-feed-header ekit-feed-header-behance">
                        ...
                        <div class="header-left">
                            ...
                            <div class="ekit-feed-header--thumbnail">
                                <img src="<?php echo $user_profile_pic ?>" alt="<?php echo $user_display_name ?>">
                            </div>
                            <!-- End thumbnail -->
                            <div>
								...
								<?php if(!empty($user_location)): ?>
                                    <div class='ekit-feed-header--location'>
                                        <?php 
                                            ...
                                            if ( $is_new || $migrated ) :
                                                \Elementor\Icons_Manager::render_icon( $user_desc_icons, [ 'aria-hidden' => 'true'] );
                                            else : ?>
                                                <i class="<?php echo $user_desc_icon; ?>" aria-hidden="true"></i>
                                            <?php endif;
                                        ?>
                        ...
                        <div class="header-right">
                            <div class="ekit-feed-header--actions">
                                <a href="<?php echo $user->url ?>" target="_" class="btn btn-primary btn-pill">
                                    <?php echo esc_html__('Follow', 'elementsKit-lite')?>
                                </a>
                                <a href="<?php echo $user->url ?>" target="_" class="btn btn-outline-secondary btn-pill">
                                    <?php echo esc_html__('Message', 'elementsKit-lite')?>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ekit-feed-items-wrapper ekit-feed-items-wrapper-behance">
                        <div class="row">
                            <?php foreach($sliced_items as $item):
                                ...
                                $img_url = $this->get_cover_image_src($item, $column_count); 
                            ...
                            ?>
                                <div class="<?php echo esc_attr($column_count) ?>">
                                    <!-- Start feed item -->
                                    <div class="ekit-feed-item ekit-feed-item-behance <?php echo $card_styles ?>">
                                        <!-- Start cover photo -->
                                        <div class="ekit-feed-item--cover">
                                            <img src="<?php echo $img_url ?>" alt="<?php echo $item->name ?>"/>
												...
												<?php else: ?>
                                                    <a href="<?php echo $item->url ?>" target="_blank">
                                                        <?php
                                                            ...
                                                            if ( $is_new || $migrated ) :
                                                                \Elementor\Icons_Manager::render_icon( $arrow_icons, [ 'aria-hidden' => 'true'] );
                                                            else : ?>
                                                                <i class="<?php echo $arrow_icon; ?>" aria-hidden="true"></i>
                                                            <?php endif;
                                                        ?>
                                                    </a>
												<?php endif; ?>
                                                ...
                                                <div class="ekit-feed-item--overview">
                                                    <div class="likes">
                                                        <?php 
                                                            ...
                                                            if ( $is_new || $migrated ) :
                                                                \Elementor\Icons_Manager::render_icon( $likes_icons, [ 'aria-hidden' => 'true'] );
                                                            else : ?>
                                                                <i class="<?php echo $likes_icon; ?>" aria-hidden="true"></i>
                                                            <?php endif;
                                                        ?>
                                                        <span>
	                                                        <?php echo $appreciations ?>
                                                        </span>
                                                    </div>
                                                    <div class="views">
                                                        <?php 
                                                            ...
                                                            if ( $is_new || $migrated ) :
                                                                \Elementor\Icons_Manager::render_icon( $views_icons, [ 'aria-hidden' => 'true'] );
                                                            else : ?>
                                                                <i class="<?php echo $views_icon; ?>" aria-hidden="true"></i>
                                                            <?php endif;
                                                        ?>
                                                        <span>
	                                                        <?php echo $views ?>
                                                    ...
                                                    <div class="comments">
                                                        <?php 
                                                            ...
                                                            if ( $is_new || $migrated ) :
                                                                \Elementor\Icons_Manager::render_icon( $comments_icons, [ 'aria-hidden' => 'true'] );
                                                            else : ?>
                                                                <i class="<?php echo $comments_icon; ?>" aria-hidden="true"></i>
                                                            <?php endif;
                                                        ?>
                                                        <span>
	                                                        <?php echo $comments ?>
                ...
                <div>
                    <strong>
                        <?php echo esc_html__('Data fetch error', 'elementsKit-lite')?>
                    </strong>
                </div>
				<?php
	...
	private function get_cover_image_src($item, $col_size) {
		...
		if($col_size == 'col-lg-2 col-md-6' || $col_size == 'col-lg-3 col-md-6') {
			$size = 202;
		} elseif($col_size == 'col-lg-4 col-md-6' || $col_size == 'col-lg-6 col-md-6') {
			$size = 404;
		} else {
			$size = 808;
		}
